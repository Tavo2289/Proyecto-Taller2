...
namespace Proyecto_Taller2
{
    public partial class frm_reporteCompras : Form
    {
        ...
        private void frm_reporteCompras_Load(object sender, EventArgs e)
        {
            ...
            {
                comboProveedor.Items.Add(new OpcionCombo() { Valor = item.id_proveedor, Texto = item.razon_social });
            }
        ...
        private void btn_busquedaProveedor_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se pueden buscar compras en fechas futuras.", "Error de Fechas", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (lista.Count < 1)
            {
                MessageBox.Show("No se encontraron compras en el rango de fechas y proveedor seleccionados. Verifique que haya compras cargadas.", "Sin Resultados", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        private void btn_exportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                savefile.FileName = string.Format("ReporteCompras_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));// nombre del archivo
        ...
        private void btn_busqueda_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No hay compras cargadas que pueda buscar", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
