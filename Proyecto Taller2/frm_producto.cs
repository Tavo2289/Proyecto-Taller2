...
namespace Proyecto_Taller2
{
    public partial class frm_producto : Form
    {
        ...
        private void lbl_detallaProducto_Click(object sender, EventArgs e)
        {
        ...
        private void lbl_estadoProducto_Click(object sender, EventArgs e)
        {
        ...
        private void lbl_CategoriaProducto_Click(object sender, EventArgs e)
        {
        ...
        private void txt_apellidoProducto_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txt_contraseñaProducto_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txt_documentoProducto_TextChanged(object sender, EventArgs e)
        {

        }

        private void lbl_contraseñaProducto_Click(object sender, EventArgs e)
        {
        ...
        private void lbl_documentoProducto_Click(object sender, EventArgs e)
        {
        ...
        {// metodo para verificar que los campos no esten vacios y que el numero de documento sea numerico
            ...
            if (new[] { txt_codigo, txt_nombre, txt_descripcion }.Any(tb => string.IsNullOrWhiteSpace(tb.Text))) // verifica que los campos no esten vacios
            {
                MessageBox.Show("Todos los campos deben estar completos.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }

            if (int.TryParse(txt_codigo.Text, out _)) { } //int.tryparse verificar que el valor ingresado sea numerico
            ...
            if (Regex.IsMatch(txt_nombre.Text, @"^[a-zA-Z]+$")) //verifica que solo contenga letras (mayúsculas o minúsculas)
            {
            ...
            {
                MessageBox.Show("Ingresa correctamente el nombre del producto", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }

            //if (Regex.IsMatch(txt_descripcion.Text, @"^[a-zA-Z]+$"))
            //{
            //    // Es solo texto (letras mayúsculas o minúsculas)
            ...
            //    MessageBox.Show("Ingresa correctamente la descripcion", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    return false;
            //}
