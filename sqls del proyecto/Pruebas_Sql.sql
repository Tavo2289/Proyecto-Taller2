...
---------------------------------------------------------------------------
/*consulta producto y categoria*/
select * from Producto

select p.id_producto, p.codigo, p.nombre_producto, p.descripcion, c.id_categoria,c.nombre_categoria[descripcionCategoria], p.precio_compra, p.precio_venta,p.estado from Producto p
...
insert into Producto(codigo, nombre_producto, descripcion, id_categoria, estado,precio_compra, precio_venta) values('1234','vacio','2kg',6,1,50,30)
insert into Producto(codigo, nombre_producto, descripcion, id_categoria, estado,precio_compra, precio_venta) values('1233','carne','2kg',6,1,30,50)


update Producto  set precio_compra = 30 , precio_venta=40 where id_producto =5

go
/*agregamos algunas tablas a los productos*/
select * from Categoria

alter table Producto drop column id_proveedor

ALTER TABLE Producto
ADD precio_venta decimal(10,2)

ALTER TABLE Producto
ADD precio_compra decimal(10,2)
...
ALTER TABLE Producto
ADD constraint df_stock_minimo default 1 for stock_minimo 


ALTER TABLE Producto
ADD constraint df_stock default 1 for stock 


ALTER TABLE Producto
ADD constraint df_precioCompra default 1 for precio_compra


ALTER TABLE Producto
ADD constraint df_precioVenta default 1 for precio_venta
